...
class FortniteSkinWikiSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        FortniteSkinWiki::insert([
            ...
            ['name'=>"DJBop", 'vbuck_price' => "2000", 'rarity' => "Legendary",'season' => "7" , "image" => 'DjBop', 'created_at' => $currentTimestamp , 'updated_at' => $currentTimestamp],
            ...
            ['name'=>"Leviathan", 'vbuck_price' => "2000", 'rarity' => "Legendary" ,'season' => "3" , "image" => 'Leviathan', 'created_at' => $currentTimestamp , 'updated_at' => $currentTimestamp],
